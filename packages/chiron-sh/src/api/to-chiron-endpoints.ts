...
import type { ChironEndpoint, ChironMiddleware } from "./call";
import type { ChironContext, HookEndpointContext } from "../types";
...
export function toChironEndpoints<E extends Record<string, ChironEndpoint>>(
	endpoints: E,
	ctx: ChironContext | Promise<ChironContext>
) {
	const api: Record<
		string,
		((
...
function getHooks(authContext: ChironContext) {
