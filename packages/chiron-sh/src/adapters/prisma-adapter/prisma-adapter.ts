...
import type { Adapter, ChironOptions, Where } from "../../types";
...
const createTransform = (config: PrismaConfig, options: ChironOptions) => {
	const schema = getSubscriptionManagementTables(options);
...
export const prismaAdapter =
	(prisma: PrismaClient, config: PrismaConfig) => (options: ChironOptions) => {
